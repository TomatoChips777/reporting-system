            ...
            <Modal.Body>
                ...
                {imagePreview && (
                    <div className="mb-3 text-center">
                        <Image src={imagePreview} alt="Preview" thumbnail className="mb-2" style={{ maxHeight: "250px" }} /><br></br>
                ...
                <Form onSubmit={handleSubmit}>
                    <InputGroup>
                        ...
                        <Button type="submit" variant="primary" disabled={loading || (!formData.message.trim() && !formData.image)}>
