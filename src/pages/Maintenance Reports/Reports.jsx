...
function Reports() {
    ...
    //     fetch(`http://localhost:5000/api/reports/admin/${selectedReport.id}`, {
    //         method: "PUT",
    //         headers: { "Content-Type": "application/json" },
    //         body: JSON.stringify({ status: selectedReport.status }),
    //     })
    //         .then((res) => res.json())
    //         .then((data) => {
    //             if (data.success) {
    ...
    const handleUpdateStatus = async () => {
        ...
        try {
            const response = await axios.put(
                `http://localhost:5000/api/reports/admin/edit/${selectedReport.id}`, // Updated API route
